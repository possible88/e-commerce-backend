# Generated by Django 4.1.7 on 2024-04-02 13:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, default='defualtpics/index5.png', null=True, upload_to='defualtpics')),
                ('phone', models.CharField(max_length=15, unique=True)),
                ('skill', models.CharField(max_length=255)),
                ('about_me', models.CharField(max_length=255)),
                ('is_User', models.BooleanField(default=True)),
                ('num_Like', models.IntegerField()),
                ('num_Post', models.IntegerField()),
